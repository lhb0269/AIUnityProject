...
### 작업 배경
초기 프로젝트 구성방식은 Singleton과 Static method에 많이 의존하는 형태였습니다.<br />
이는 테스트 간 종속이 생기게 만들었고, 몇몇 테스트는 독립성이 깨지기도 하였습니다.<br />
...
위 MD에서의 테스트 수행은 수동 테스트보다 자동 테스트가 더 효율적이라 판단했습니다.<br />
실제로 아직 프로젝트는 버튼 클릭시 팝업 노출 또는 로그 출력만이 구현되어있는 상태이기에<br />
